...
export default function App() {
  ...
  //TODO Ensure Microphone Permissions
  const ensureMicrophonePermission = async (): Promise<boolean> => {
    ...
    try {
      ...
      permissionStatus = await requestRecordingPermissionsAsync(); // Prompt for permissions
  ...
  //TODO: Helper Function to Format Model Sizes 
  ...
  const transcribeAudio = async () => {
    ...
    try {
      ...
      const { promise } = whisperContext.transcribe(expoAudioPath.uri, options); // transcribe - will return stop and subscribe 
  ...
  //! USER INTERFACE - MAIN APP FRONTEND
  return (
